# -*- coding: utf-8 -*-
"""
Created on Thu Dec 21 17:39:32 2023
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for i, hand_landmarks in enumerate(results.multi_hand_landmarks):
            ...
            threshold_distance_tip_mcp = 0.4
    ...
    abs(thumb_tip.y - middle_mcp.y) < threshold_vertical_alignment and
    abs(thumb_tip.y - ring_mcp.y) < threshold_vertical_alignment and
    abs(thumb_tip.y - pinky_mcp.y) < threshold_vertical_alignment
            )
